...
const FeatureCard = ({ feature, index }) => (
  ...
  >
    ...
    <div className="bg-gray-50 px-6 py-4">
      <Link href={feature.href} className="text-sm font-medium text-indigo-600 hover:text-indigo-500 transition-colors duration-300">
...
export default function DashboardPage() {
  ...
  if (!isLoaded || !isSignedIn) {
    return (
      <Layout>
        <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 pt-24 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white shadow-2xl rounded-lg overflow-hidden">
              <div className="px-4 py-5 sm:p-6">
                ...
                <Link href="/sign-in" className="inline-block bg-indigo-600 text-white px-6 py-3 rounded-md font-medium hover:bg-indigo-500 transition-colors duration-300">Sign In</Link>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <Layout>
      <motion.div
        ...
        className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 pt-24 pb-12 px-4 sm:px-6 lg:px-8"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: -50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="bg-white shadow-2xl rounded-lg overflow-hidden mb-8"
          >
                    ...
                    {activities.map((activity) => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <p className="text-sm font-medium text-indigo-600">{activity.description}</p>
